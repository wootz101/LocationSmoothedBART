# Reproducing Plots for the Friedman regression Problem
...
for(i in 1:2000){
  c1_s_data = cbind(c1_s_data, X_1 + rnorm(10,sd=0.1) )
  c2_s_data = cbind(c2_s_data, X_2 + rnorm(10,sd=0.1) )
  c3_s_data = cbind(c3_s_data, X_3 + rnorm(10,sd=0.1) )
  c4_s_data = cbind(c4_s_data, X_4 + rnorm(10,sd=0.1) )
  c5_s_data = cbind(c5_s_data, X_5 + rnorm(10,sd=0.1) )
}
...
ggplot(data, aes(x = x)) +
  geom_line(aes(y = y1, color = "F. Regression"), size = 1.5) +
  geom_point(aes(y = y1, color = "F. Regression"), size = 3) +
  ...
  geom_line(aes(y = y5, color = "Random Forest"), size = 1.5) +
  geom_point(aes(y = y5, color = "Random Forest"), size = 3) +
