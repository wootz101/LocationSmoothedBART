---
title: "Vignette: lsBART for binary response variable"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Vignette: lsBART for binary response variable}
...
# All generated 4 predictor functions plots
...
Here, we display the training data to verify the structure and the binary response variable.
...
## Classification accuracy and AUC curve on Test set
